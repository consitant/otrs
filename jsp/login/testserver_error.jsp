...
<body>
	...
	<div class="wrapper">
		...
		<form name="loginform" method="POST" action='<%= response.encodeURL("j_security_check") %>?testserver=true' class='login'>
...
-->
			...
			<div class="error">Benutzername oder Passwort ungültig! <br />Bitte versuchen Sie es erneut.</div>
